...
/*定义Manager类*/
function Manager(name,salary,number,office,work,inferiors){
	this.name = name;
	this.salary = salary;
	this.number = number;
	this.office = office;
	...
	var employee = new Employee(name,salary,number,office,work);
...
/*定义Secretary类*/
function Secretary(name,salary,number,office,work,superior){
	this.name = name;
	this.salary = salary;
	this.number = number;
	this.office = office;
